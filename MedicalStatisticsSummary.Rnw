...
\subsbsection{Mantel-Haenszel test}
...
\begin{equation}
SE(log(RR)) = \sqrt{\frac{1}{a} - \frac{1}{a+b} + \frac{1}{c} - \frac{1}{c+d}} \Rightarrow log(RR) \pm 2 SE(log(RR))
\end{equation}
...
\begin{equation}
\frac{\bar{D}_1 - \bar{D}_2}{\sqrt{s_{\bar{D}_1}^2}/n_1 + 
