...
The \textbf{resolution} is the highest order of interaction that is possible to investigate.
...
\section{Old exam problem: Orthogonality, optimality}
...
\subsection{Choice of sample size: Statified Sampling}

\paragraph{Proportional allocation}
